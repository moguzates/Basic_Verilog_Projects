...
HD_PWD='C:/Users/Mustafa/Desktop/Verilog/Finite_State_Machines_3/Finite_State_Machines_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Finite_State_Machines_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Finite_State_Machines_3.tcl
