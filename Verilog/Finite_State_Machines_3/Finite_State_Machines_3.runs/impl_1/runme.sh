...
HD_PWD='C:/Users/Mustafa/Desktop/Verilog/Finite_State_Machines_3/Finite_State_Machines_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Finite_State_Machines_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Finite_State_Machines_3.tcl -notrace
